...
class GenresMoviesRepo(private val genresApi: GenresApi){

    suspend fun getGenresMovies():ResponseHandler<GeneresDTO>{
        return try {
            ResponseHandler.Success(genresApi.getGenresMovies())
